...
// let nameOfPerson: string = "ALI HAIDER";
// let cases: string = nameOfPerson.toLowerCase();
// console.log(cases);
// let cases2: string = nameOfPerson.toUpperCase();
// console.log(cases2);
// const cases3: string[] = nameOfPerson.split(" ");
// console.log(cases3);
// const titlecaseName: string = cases3
//   .map(
...
// let quote:string="Don't be afraid of losing people, but be afraid that you don't lose yourself while making people happy.";
// let author:string="Bano Qudsia";
// console.log(`${author} once said,"${quote}"`);
// Famous Quote 2: Repeat Exercise 4, but this time store the famous person’s name in a variable called famous_person. Then compose your message and store it in a new variable called message. Print your message.
// let quote:string="Don't be afraid of losing people, but be afraid that you don't lose yourself while making people happy.";
// let famous_person:string="Bano Qudsia";
// let message:string=`${famous_person} once said,"${quote}"`;
// console.log(message);
// Stripping Names: Store a person’s name, and include some whitespace characters at the beginning and end of the name. Make sure you use each character combination, "\t" and "\n", at least once. Print the name once, so the whitespace around the name is displayed. Then print the name after striping the white spaces.
// let name_of_person:string="    \tali junaid sadique\n           ";
// console.log(name_of_person);
// let striping:string=name_of_person.trim();
// console.log(striping);
// Number Eight: Write addition, subtraction, multiplication, and division operations that each result in the number 8. Be sure to enclose your operations in print statements to see the results.
// const additionResult: number = 4 + 4;
...
// let myFavouriteNum:number=22;
// let message:string=`Your Favourite Number is ${myFavouriteNum}`
// console.log(message);
...
// const favouriteModesOfTransport: string[] = ["Grande", "Porsche 911", "Honda Civic", "Honda Prius Hybrid"];
...
//   console.log(`Dear ${guest}, you are cordially invited to dinner. We would be honored to have you join us.`);
// });
// let absentee:string|undefined= guests.pop();
// guests.push('Mahnoor');
